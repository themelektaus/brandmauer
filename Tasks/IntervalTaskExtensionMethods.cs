...
public static class IntervalTaskExtensionMethods
{
    ...
    public static void RunInBackground<T>(this WebApplication @this) where T : IntervalTask
    {
        ...
        if (paramters.Length > 0)
            instance = Activator.CreateInstance(typeof(T), [@this]) as IntervalTask;
        else
    ...
    public static async Task DisposeAllIntervalTasksAsync(this WebApplication _)
    {
